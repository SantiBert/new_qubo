...
urlpatterns = [
    ...
    path('administration/contac/<int:pk>/',
         ConctacAdminDetailView.as_view(), name="admincontactdetail"),
    path('administration/contac/alter-state/<int:contact_id>',
         ContactChangeStateView.as_view(), name="contactchangestate"),
]
